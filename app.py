...
Original file is located at
    https://colab.research.google.com/drive/1JcXlCRKaod1U-0bqES1d60bsOWvnuTBo
"""
...
st.markdown("Talk to me anything in English, Hindi, Telugu, Tamil. Trained on a bit data and try my level best!")
...
if st.button("Send") and user_input.strip():
    with st.spinner("Thinking..."):
        prompt = f"User: {user_input.strip()} Bot:"
